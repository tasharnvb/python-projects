# Guess Your Number 2.0
#
# This is an improved version of the Guess Your Number game.
# It has been improved so that the game always has an ending
# as the computer will home in on the number based on its
# previous guesses.
